...
int main(){
    ...
    const float commission_limit(80),commission_factor(0.04);
  ...
  else if (hours_worked >=commission_limit)
  {
     wage =(commission_limit+(hours_worked-commission_limit)*commission_factor)*hourly_rate;
